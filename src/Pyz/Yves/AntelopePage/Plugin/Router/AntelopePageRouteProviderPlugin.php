...
class AntelopePageRouteProviderPlugin extends AbstractRouteProviderPlugin
{
    ...
    private function addAntelopeAntelopeGetRoute(RouteCollection $routeCollection): RouteCollection
    {
        $route = $this->buildRoute('antelope/antelope/{name}', 'AntelopePage', 'Antelope', 'getAction');
